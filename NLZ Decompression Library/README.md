...
# Notes
This compression format was designed and optimized for the SEGA Mega Drive's 4bpp tile-based art data. That said, it performs respectably on other, more general forms of data as well.
